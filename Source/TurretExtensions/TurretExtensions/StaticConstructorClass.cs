...
namespace TurretExtensions
{
    ...
    public static class StaticConstructorClass
    {
        static StaticConstructorClass()
        {
            ...
            foreach (var tDef in allThingDefs.Where(tDef => tDef.building != null && tDef.building.IsTurret && (tDef.statBases == null || !tDef.statBases.Any(s => s.stat == StatDefOf.ShootingAccuracyTurret))))
            {
