...
public static class Patch_Pawn_RotationTracker
{
    ...
    public static class UpdateRotation
    {
        public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
        {
            ...
            var draftedGetterInfo = AccessTools.Property(typeof(Pawn), "Drafted").GetGetMethod();
            var canRotateDraftedPawnInfo = AccessTools.Method(typeof(UpdateRotation), "CanRotateDraftedPawn");
            checked
            {
